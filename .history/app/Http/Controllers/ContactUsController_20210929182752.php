...
class ContactUsController extends Controller
{
    ...
    public function ContactUs(Request $request)
    {
        ...
        $subject = filter_var($$request->name, FILTER_SANITIZE_STRING);
        $message = filter_var($request->name, FILTER_SANITIZE_STRING);
        $checkbox = filter_var($request->name, FILTER_SANITIZE_STRING);
