            ...
            <div class="project__hero bg-overlay bg-overlay--light">
                ...
                <div class="container">
                    ...
                    <div class="project__hero-info">
                        ...
                        <p class="project__hero-description">Learn to read, write and speak Sinhala through engaging online classes.</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <p class="project__info-description lead">One of Sri Lanka's national languages, Sinhala is spoken by about 75% of the population. Lyceum Oceania strongly emphasises helping children living outside Sri Lanka improve their fluency in reading, writing and speaking in Sinhala, helping them connect with their roots and include Sri Lankan culture as part of their identity.</p>
                        </div>
