            ...
            <div class="project__hero bg-overlay bg-overlay--light">
                ...
                <div class="container">
                    ...
                    <div class="project__hero-info">
                        <h1 class="project__hero-title">Sri Lankan Calture</h1>
                        <p class="project__hero-description">Gain insight into the unique aspects of Sri Lankan culture.</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <p class="project__info-description lead">Strongly defined by cultural values and the significance of unique traditions, Sri Lankans highly value the connections and customs of their country. Sri Lankan culture is even more fascinating when learning more about the meaning or story behind folk dances, festivals, plays or even traditional foods. Understanding the culture of Sri Lanka is a great way to make a strong connection with the country, and celebrate the special attributes of what it means to be Sri Lankan.</p>
                        </div>
