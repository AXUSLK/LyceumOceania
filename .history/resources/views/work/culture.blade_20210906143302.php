                            ...
                            <div class="project__process">
                                <div class="animate">
                                    <div class="animate-container">
                                        ...
                                        <p class="project__process-description lead">We also provide tangible results
                                            and measurable long-term value business. Lorem ipsum dolor sit amet,
                                            consectetur
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <figure class="project__gallery-img-holder">
                                <div class="animate">
                                    <div class="animate-container">
                                        <img src="img/works/single_project_image_gallery_1.jpg" alt=""
                        ...
                        <div class="col-lg-6">
                            <figure class="project__gallery-img-holder">
                                <div class="animate">
                                    <div class="animate-container">
                                        <img src="img/works/single_project_image_gallery_2.jpg" alt=""
                                            class="project__gallery-item">
                                    </div>
                                </div>
                            </figure>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <figure class="project__gallery-img-holder">
                                <div class="animate">
                                    <div class="animate-container">
                                        <img src="img/works/single_project_image_gallery_3.jpg" alt=""
                                            class="project__gallery-item">
                                    </div>
                                </div>
                            </figure>
                        ...
                        <div class="col-lg-4">
                            <figure class="project__gallery-img-holder">
                                <div class="animate">
                                    <div class="animate-container">
                                        <img src="img/works/single_project_image_gallery_4.jpg" alt=""
                                            class="project__gallery-item">
                                    </div>
                                </div>
                            </figure>
                        ...
                        <div class="col-lg-4">
                            <figure class="project__gallery-img-holder">
                                <div class="animate">
                                    <div class="animate-container">
                                        <img src="img/works/single_project_image_gallery_5.jpg" alt=""
                                            class="project__gallery-item">
                                    </div>
                                </div>
                            </figure>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="testimonial testimonial-1">
                                <figure class="testimonial-1__img-holder">
                                    <img src="img/testimonials/single_project_testimonial.jpg"
                                        class="testimonial__img testimonial-1__img" alt="testimonial_1">
                                </figure>
                                <div class="testimonial__body testimonial-1__body">
                                    <p class="testimonial__text testimonial-1__text">“I’am amazed, I should say thank
                                        you so much for
                    ...
                    <div class="row">
                            ...
                            <article class="related-project" itemscope itemtype="http://schema.org/Article">
                                <div class="related-project__header hover-shrink">
                                    <a href="single-project.html" class="d-block hover-shrink--shrink">
                                        <img src="img/works/single_project_related_1.jpg"
                                            class="related-project__img hover-shrink--zoom" itemprop="image" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <article class="related-project" itemscope itemtype="http://schema.org/Article">
                                <div class="related-project__header hover-shrink">
                                    <a href="single-project.html" class="d-block hover-shrink--shrink">
                                        <img src="img/works/single_project_related_2.jpg"
                                            class="related-project__img hover-shrink--zoom" itemprop="image" alt="">
                                    </a>
                                </div>
                                <div class="related-project__body">
                        ...
                        <div class="col-md-4">
                            <article class="related-project" itemscope itemtype="http://schema.org/Article">
                                <div class="related-project__header hover-shrink">
                                    <a href="single-project.html" class="d-block hover-shrink--shrink">
                                        <img src="img/works/single_project_related_3.jpg"
                                            class="related-project__img hover-shrink--zoom" itemprop="image" alt="">
                                    </a>
                                </div>
                                <div class="related-project__body">
