            ...
            <div class="project__hero bg-overlay bg-overlay--light">
                ...
                <div class="container">
                    ...
                    <div class="project__hero-info">
                        <h1 class="project__hero-title">Sri Lankan Heritage</h1>
                        <p class="project__hero-description">Understand the roots of Sri Lanka by exploring the past.</p>
                    </div>
                </div>
            ...
            <section class="section-project-info pb-96">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <h2 class="project__info-title">Sri Lankan Heritage</h2>
                ...
                <div class="project__image-full">
                    <div class="animate">
                        <div class="animate-container">
                            <img src="img/works//details/4.jpg" alt="">
                        </div>
                    </div>
                </div>
