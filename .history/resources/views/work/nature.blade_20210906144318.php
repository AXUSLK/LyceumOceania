    ...
    <main class="main-wrap">
        ...
        <div class="content-wrap">
            ...
            <div class="project__hero bg-overlay bg-overlay--light">
                <figure class="project__hero-img-holder" style="background-image: url(img/works/details/5.jpg);">
                    <img src="img/works/details/5.jpg" alt="" class="d-none">
                </figure>
                <div class="container">
                ...
                <div class="project__image-full">
                    <div class="animate">
                        <div class="animate-container">
                            <img src="img/works//details/6.jpg" alt="">
                        </div>
                    </div>
                </div>
