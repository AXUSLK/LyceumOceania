...
<head>
    <title>Lyceum Oceania | Learning a language is a motivation and an amusing asset!!!</title>
                ...
                <div class="container">
                    <div class="animate">
                        <div class="animate-container">
                            <p class="intro__text text-center">Lyceum International Schools are extending their wings to
                                Australia with an innovative project “Lyceum Oceania”.
                                This unique project brings together the Sri Lankan children who live in Australia to one
                                platform, allowing them to embrace their culture and tradition through learning the
                                Sinhala language
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-5">
                            <div class="title-row animate">
                                <div class="animate-container">
                                    ...
                                    <p class="section-description">Lyceum is a well-reputed body of educators in Sri
                                        Lanka who has gained this well-deserved reputation for providing high-quality
                                        education in a friendly and supportive environment. We offer education that
                                        matters tomorrow and that which crafts a global citizen who will reshape the
                                        future.
                                        It has been our mission for the past 27 years to enhance the potential of every
                                        young soul that passes through our halls empowering them to be the best they can
                                        be
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">We have implemented a rigorous online teaching
                                                    program to ensure an uninterrupted learning experience.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">We as Lyceum holds the weight of decades-long
                                                    trust of many generations of parents, teachers, and dear students.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">Exploring your roots is nothing less than
                                                    powerful to anybody living abroad. This will be the wealth your
                                                    future generations will inherit

                                                    {{-- There is power in learning
                                                    language of where you came from... at is the heirloom to pass down
                                                    to your children when they search for a sense of identity in a
                                                    foreign land. --}}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">Lyceum teachers are passionate, committed, and
                                                    caring professionals
                                                    who guide and nurture students to explore their talents and fulfill
                                                    their dreams.

                                                    {{-- Our
                                                    pedagogical practice in Lyceum
                                                    Oceania is based on bilingual teacher interaction with adequate
                                                    training and experience in
                                                    language teaching. Our highly experienced and well qualified
                                                    teachers believe in an active
                                                    learning approach, placing the child at the hear of the learning
                                                    process. --}}
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div class="animate-container">
                                    <div class="title-row mb-40">
                                        ...
                                        <h2 class="section-title">Award-Winning
                                            Business Startup</h2>
                                        <p class="section-description">Learning a language is a motivation and an
                                            amusing asset!!!</p>
                                    </div>
                                            ...
                                            <div class="accordion__panel">
                                                ...
                                                <div id="collapse-1" class="collapse show" data-parent="#accordion-1"
                                                    ...
                                                    <div class="accordion__body">
                                                        <p>
                                                            Lyceum International Schools are an all-inclusive and highly
                                                            reputed education service located in Sri Lanka, where
                                                            children can safely nurture who they are and what they want
                                                            to be. Over the years, Lyceum has transformed thousands of
                                                            children into successful students and shaped them into
                                                            high-achieving well-sounded adults with dynamic careers
                                                            worldwide.
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="accordion">
                                            <div class="accordion__panel">
                                                ...
                                                <div id="collapse-2" class="collapse" data-parent="#accordion-1"
                                                    ...
                                                    <div class="accordion__body">
                                                        <p>
                                                            Providing a safe and nurturing learning environment in which
                                                            children can discover the enjoyment of learning. We seek to
                                                            deliver both academic excellence and personal growth helping
                                                            students to become the next leaders of the world.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion__panel">
                                                <div class="accordion__heading" id="heading-3">
                                                    <a data-toggle="collapse" href="#collapse-3"
                                                        ...
                                                        <span class="accordion__toggle"></span>
                                                        <h4 class="accordion__title">Learning strategies</h4>
                                                    </a>
                                                </div>
                                                <div id="collapse-3" class="collapse" data-parent="#accordion-1"
                                                    ...
                                                    <div class="accordion__body">
                                                        <p>
                                                            ...
                                                            by building tailored programs to develop language
                                                            competency. Lessons are planned in such a way that the
                                                            learners will be able to interact in the Sinhala language in
                                                            real-life situations. Our pedagogical practice in Lyceum
                                                            Oceania is based on bilingual teacher interaction with
                                                            adequate training and experience in language teaching. Our
                                                            highly experienced and well-q ualified teachers believe in
                                                            an active learning approach, placing the child at the heart
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="title-row text-center">
                                ...
                                <p class="section-description">We utilize an interactive teaching method and a
                                    communicative and practical approach to facilitate Sinhala
                                    language learning. </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="projects-slider">
                    <div class="flickity-slide">
                        <article class="project project-slide hover-shrink">
                            <a target="_blank" href="/sri-lankan-nature" class="project__url">
                            ...
                            <div class="project__description-wrap">
                                <div class="project__description">
                                    <h3 class="project__title"><a target="_blank" href="/sri-lankan-culture">Nature</a>
                                    </h3>
                    ...
                    <div class="flickity-slide">
                        <article class="project project-slide hover-shrink">
                            <a target="_blank" href="/sri-lankan-culture" class="project__url">
                                <figure class="project__img-holder hover-shrink--shrink">
                            ...
                            <div class="project__description-wrap">
                                <div class="project__description">
                                    <h3 class="project__title"><a target="_blank"
                                            href="/sri-lankan-culture">Culture</a></h3>
                    ...
                    <div class="flickity-slide">
                        <article class="project project-slide hover-shrink">
                            <a target="_blank" href="/sri-lankan-heritage" class="project__url">
                                <figure class="project__img-holder hover-shrink--shrink">
                            ...
                            <div class="project__description-wrap">
                                <div class="project__description">
                                    <h3 class="project__title"><a target="_blank"
                                            href="/sri-lankan-heritage">Heritage</a>
                                    </h3>
                    ...
                    <div class="flickity-slide">
                        <article class="project project-slide hover-shrink">
                            <a target="_blank" href="/sri-lankan-language" class="project__url">
                                <figure class="project__img-holder hover-shrink--shrink">
                            ...
                            <div class="project__description-wrap">
                                <div class="project__description">
                                    <h3 class="project__title"><a target="_blank"
                                            href="/sri-lankan-language">Language</a></h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#contact-form__submit').on('click', function(e) {
                ...
                let branch = $(this).val();
                let school_type = $("input[name='school_type']:checked").val();

                let applyfor = $('#ApplyFor').val();

                var SchoolTypeData = new FormData();
                var url = '/get-leaf-schools';

                SchoolTypeData.append('branch', branch);
                SchoolTypeData.append('school_type', school_type);


                if (applyfor == 3) {

                    $('#leaf_schools_div').show();
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: SchoolTypeData,
                        // data: { SchoolTypeData: SchoolTypeData, _token: '{{ csrf_token() }}' },
                        success: function(data) {

                            $.each(data.leaf_schools, function(index, item) {
                                $('#leaf_schools').append('<option value=' + item + '>' + index +
                                    '</option>');
                            });
                        },
