...
<head>
    <title>Lyceum Oceania | Leaning a language is a motivation and amusing asset!!!
                            Learning a language is a motivation and an amusing asset!!!
    </title>
                    ...
                    <div class="animate">
                        <div class="animate-container">
                            <p class="intro__text text-center">Lyceum International Schools are extending their wings to
                                Australia with an innovative project ‘Lyceum Oceania’. This unique project beings
                                together the Sri Lankan children live in Australia to one platform allowing them to
                                embrace their culture and tradition through learning Sinhala language.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-5">
                            <div class="title-row animate">
                                <div class="animate-container">
                                    ...
                                    <p class="section-description">Lyceum has gained a well-deserved reputation for
                                        providing high quality education in a friendly and supportive environment. We
                                        offer education that matters tomorrow a school providing education inspired by
                                        and fit for the future.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="title-row text-center">
                                ...
                                <p class="section-description">We utilize an interactive teaching method and a communicative and practical approach to
