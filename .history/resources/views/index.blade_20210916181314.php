                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">PWe have implemented a rigorous online teaching programme to ensure uninterrupted learning Experience.</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">Exploring your roots is nothing less than powerful to anybody living abroad. There is power in learning language of where you came from... at is the heirloom to pass down to your children when they search for a sense of identity in a foreign land.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="service">
                                                ...
                                                <p class="service__text">Lyceum teachers are passionate, committed and caring professionals who guide and nurture
                                                    students to explore their talents and fulfill their dreams. Our pedagogical practice in Lyceum
                                                    Oceania is based on bilingual teacher interaction with adequate training and experience in
                                                    language teaching. Our highly experienced and well qualified teachers believe in an active
                                                    learning approach, placing the child at the hear of the learning process.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
