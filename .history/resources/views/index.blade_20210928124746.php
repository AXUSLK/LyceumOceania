                                ...
                                <div class="animate-container">
                                    <div class="title-row mb-40">
                                        ...
                                        <h2 class="section-title">Award-Winning
                                            Business Startup</h2>
                                        <p class="section-description">Learning a language is a motivation and an amusing asset!!!</p>
                                    </div>
                                        ...
                                        <div class="accordion">
                                            <div class="accordion__panel">
                                                ...
                                                <div id="collapse-2" class="collapse" data-parent="#accordion-1"
                                                    ...
                                                    <div class="accordion__body">
                                                        <p>
                                                            Providing a safe and nurturing learning environment in which children can discover the enjoyment of learning. We seek to deliver both academic excellence and personal growth helping students to become the next leaders of the world.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="collapse-3" class="collapse" data-parent="#accordion-1"
                                                    ...
                                                    <div class="accordion__body">
                                                        <p>
                                                            ...
                                                            facilitate Sinhala language leaning. We create positive
                                                            learning environment by building
                                                            tailored programmes to develop the language competency.
                                                            Lessons are planned in such a way that the learners will be
                                                            able to interact in Sinhala language in a real life
                                                            situations.
                                                        </p>
                                                    </div>
                                                </div>
