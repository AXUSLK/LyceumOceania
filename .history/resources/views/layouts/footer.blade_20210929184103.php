                ...
                <form id="contact-form" class="contact-form" action="">
                    ...
                    <div class="gdpr-checkbox">
                        <label class="gdpr-checkbox__label">
                            <input class="gdpr-checkbox__input" name="AGREE_TO_TERMS" type="checkbox" value="1" id='terms_agree'
                                required="">
                    ...
                    <div class="text-center">
                        <input id="contact-form__submit___new" type="submit" class="btn btn--lg btn--color"
                            value="Send Message">
                    </div>
