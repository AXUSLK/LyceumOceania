                                        ...
                                        <div class="accordion">
                                            <div class="accordion__panel">
                                                ...
                                                <div id="collapse-3" class="collapse" data-parent="#accordion-1"
                                                    ...
                                                    <div class="accordion__body">
                                                        <p>
                                                            We utilize an interactive teaching method and a communicative and practical approach to facilitate Sinhala language learning. We create a positive learning environment by building tailored programs to develop language competency. Lessons are planned in such a way that the learners will be able to interact in the Sinhala language in real-life situations. Our pedagogical practice in Lyceum Oceania is based on bilingual teacher interaction with adequate training and experience in language teaching. Our highly experienced and well-q ualified teachers believe in an active learning approach, placing the child at the heart of the learning process.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="title-row text-center">
                                ...
                                <p class="section-description">We utilize an interactive teaching method and a
                                    communicative and practical approach to
                                    facilitate Sinhala language leaning.</p>
                            </div>
                        </div>
                    </div>
                </div>
