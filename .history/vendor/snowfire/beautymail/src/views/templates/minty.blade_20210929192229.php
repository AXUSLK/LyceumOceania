<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<title></title>
	<style type="text/css">{{ file_get_contents('/../vendor/snowfire/beautymail/src/styles/css/minty.css') }}</style>
    {{ dd(app_path() . '/../vendor/snowfire/beautymail/src/styles/css/minty.css')}}
	@if($css)
	<style type="text/css">
		{{ $css }}
	</style>
