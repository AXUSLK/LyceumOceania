...
<head>
    ...
    @php
       // $variable = Config::get('file1.EMP_DOC_PATH');
        ...
        $css = Config::get('beautymail.css');
        $logo = Config::get('beautymail.vielogo');
        $unsubscribe = Config::get('beautymail.unsubscribe');
    @endphp
    {{ dd($logo) }}
    <style type="text/css">
        {{ file_get_contents(app_path() . '/../vendor/snowfire/beautymail/src/styles/css/minty.css') }}
